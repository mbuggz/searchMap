...
public class Address {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("countryCode", countryCode).append("formatted", formatted).append("components", components).append("postalCode", postalCode).toString();
    }
